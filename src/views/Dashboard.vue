<template>
    <div>
        <el-row :gutter="20">
            <el-col :span="8">
                <el-card shadow="hover" class="mgb20" style="height:170px;">
                    <div class="user-info">
                        <img src="../assets/img/IMG_2129.jpg" class="user-avator" alt />
        ...
        <el-row :gutter="20">
            <el-col :span="12">
                <el-card shadow="hover">
                    <schart ref="line" class="schart" canvasId="line3" :options="options4"></schart>
                </el-card>
            </el-col>
            <el-col :span="12">
                <el-card shadow="hover">
                    <schart ref="line" class="schart" canvasId="line4" :options="options5"></schart>
                </el-card>
            </el-col>
        </el-row>
    </div>
...
export default {
    ...
    setup() {
        ...
        const options2 = {
            ...
            labels: ["11:00", "11:15", "11:30", "11:45", "12:00"],
            datasets: [
                {
                    label: "1号终端",
                    data: [64, 62, 61, 69, 71],
